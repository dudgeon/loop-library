...
Similar knowledge-as-Wiki pattern keeps reappearing under different names: [Obsidian vaults](https://obsidian.md/help/vault) wired to coding agents, the [AGENTS.md](http://AGENTS.md) / [CLAUDE.md](http://CLAUDE.md) family of convention files, repos full of [index.md](http://index.md) and [log.md](http://log.md) artifacts that agents consult before doing real work, and "metadata as code" repositories inside data teams.
